...
time aprun -r 1 -n 1 -N 1 -cc none -d $OMP_NUM_THREADS python $PBS_O_WORKDIR/tfrecord.py -idx $PBS_O_WORKDIR/image_lists/ -tfs $PBS_O_WORKDIR/tfrecords-full/ -im $PBS_O_WORKDIR/images-full/ -cls 11166 -one True 2>&1 |& tee ${PBS_O_WORKDIR}/logfile_tfrecords_full.log 
